...
| [Generative Quantum Data Embeddings for Supervised Learning](papers/EGAS/). Source: [Heo_2065](https://arxiv.org/abs/2605.30866v1) | This is a trainable encoding paradigm. It uses a classical GPT model to create iteratively the optimal encoding that is then trained for optimal performance. The training is based on a energy type of problem. There is also a metric introduced that evaluates the potential of the use of quantum to classify the dataset.|
