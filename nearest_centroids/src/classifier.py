...
from src.functions import quantum_distance, quantum_distance_ml
...
class MLQuantumNearestCentroid(NearestCentroid):
    def __init__(self, repetitions=500, error_rate=0., error_mitigation=True, n=8):
...
class QuantumNearestCentroid(NearestCentroid):
    def __init__(self, repetitions=1000, error_rate=0., error_mitigation=True):
        self.repetitions = repetitions
        self.error_rate = error_rate
        self.error_mitigation = error_mitigation
        super().__init__(metric=self.get_metric)
