...
import torch
from lib.util import create_hybrid_model, train_environment, set_global_seed
import gymnasium as gym
from lib.util import MinigridImageOnlyWrapper
...
def train_and_evaluate(cfg: dict, run_dir: Path) -> None:
    ...
    logger.info(f"Detected dimensions for {env_name} : State = {state_dim}, Actions = {action_dim}")
