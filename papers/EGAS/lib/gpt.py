"""
Code from https://github.com/qDNA-yonsei/Generative-QDE/blob/main/EGAS_and_refinement/model.py, the original authors of the EGAS paper.
...
class GPTQE(GPT):
    ...
    @torch.no_grad()
    def generate(self, n_sequences, max_new_tokens, temperature=1.0, device=None):
