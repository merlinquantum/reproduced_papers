...
from papers.nn_embedding.utils.gate_based_embedding import QuantumEmbedding1, QCNN


@pytest.fixture
def gate_based__model() -> NeuralEmbeddingGateBasedModel:
...
def test_gate_based_model_construction(gate_based__model):
    model = gate_based__model
...
def test_distance_layer_returns_one_score_per_pair(gate_based__model):
    model = gate_based__model
...
def test_embedding_training_model_forward_shape(gate_based__model):
    model = gate_based__model
...
def test_trained_embedding_model_forward_shape(gate_based__model):
    model = gate_based__model
...
def test_complete_circuit_layer_has_trainable_classifier_params(gate_based__model):
    model = gate_based__model
...
def test_state_embedding_circuit_returns_density_matrix(gate_based__model):
    model = gate_based__model
